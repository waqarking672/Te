...
@app.route('/')
def home():
    return "I'am 𝙎𝙃 𝙓 𝘾𝙊𝘿𝙀𝙍 File Host"
...
# --- Configuration ---
TOKEN = '8238157471:AAGckJu9hnQU3tkY4z8cglowpJzm_koHa6c' # Replace with your actual token
OWNER_ID = 7531660822 # Replace with your Owner ID
ADMIN_ID = 7531660822 # Replace with your Admin ID (can be same as Owner)
YOUR_USERNAME = '@e3hacker2' # Replace with your Telegram username (without the @)
UPDATE_CHANNEL = 'https://t.me/e3hacker' # Replace with your update channel link
...
def create_main_menu_inline(user_id):
    ...
    buttons = [
        ...
        types.InlineKeyboardButton('📞 Contact Owner', url=f'https://t.me/{YOUR_USERNAME.replace("@SHHACKERDEV404", "")}')
    ]
